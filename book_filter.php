...
$location = $conn->query("SELECT id,Concat(Starting_from) as location FROM location where status = 1");
?>
<div class="container-fluid">
	<form id="find_schedule">
		<div class="col-md-12">
			...
			<?php 
				$location = $conn->query("SELECT id,Concat(Destination,', ',seats) as location FROM location where status = 1");
			?>
			<div class="form-group mb-2">
